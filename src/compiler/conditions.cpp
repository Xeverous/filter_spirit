	...
	lang::condition_set& condition_set)
{
	switch (condition.comparison_type)
	{
		case lang::comparison_condition_property::item_level:
		{
			...
			lang::numeric_range_condition nrc(condition.comparison_type, level.value);
		...
		case lang::comparison_condition_property::quality:
		{
			...
			lang::numeric_range_condition nrc(condition.comparison_type, quality.value);
		...
		case lang::comparison_condition_property::rarity:
		{
			...
			lang::rarity_range_condition rrc(condition.comparison_type, rarity);
		...
		case lang::comparison_condition_property::sockets:
		{
			...
			lang::numeric_range_condition nrc(condition.comparison_type, integer.value);
