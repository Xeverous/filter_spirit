...
log::message_stream& operator<<(log::message_stream& stream, const item_price_data& ipd)
{
	return stream << "Item price data:\n"
		...
		"\tArtifacts       : " << ipd.artifacts.size() << "\n"
		"\tTattoos         : " << ipd.tattoos.size() << "\n"
		"\tOmens           : " << ipd.omens.size() << "\n"
		"\tRunegrafts      : " << ipd.runegrafts.size() << "\n"
		...
		"\tAllflame Embers : " << ipd.scarabs.size() << "\n"
		"\tInvitations     : " << ipd.invitations.size() << "\n"
		...
		"\tUnique Tinctures (unambiguous): " << ipd.unique_tinctures.unambiguous.size() << "\n"
		"\tUnique Tinctures (ambiguous)  : " << ipd.unique_tinctures.ambiguous.size() << "\n"
		...
		"\tUnique Relics (unambiguous)   : " << ipd.unique_relics.unambiguous.size() << "\n"
		"\tUnique Relics (ambiguous)     : " << ipd.unique_relics.ambiguous.size() << "\n"
		"\tUnique Idols (unambiguous)    : " << ipd.unique_idols.unambiguous.size() << "\n"
